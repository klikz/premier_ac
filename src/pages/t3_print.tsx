...
export default function T3Print() {
  ...
  return (
    <div>
      <div style={{ marginBottom: 10 }}>T3: Printerni tanlang</div>
      <div>
        <RadioGroup
      ...
      <div style={{ marginTop: 20, justifyContent: "space-between", display: "flex", flexDirection: 'row' }}>
        <Input
          onKeyDown={(e) => {
            if (e.key === "Enter") {
          ...
          style={{borderWidth: 1.5, width: '30%'}}
